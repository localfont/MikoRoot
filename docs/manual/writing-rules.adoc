...
MikoOS or refactor existing ones.
...
used in MikoOS, which is the regular _Kconfig_. For further
...
MikoOS to generate the final image file(i.e. sdcard.img). For further

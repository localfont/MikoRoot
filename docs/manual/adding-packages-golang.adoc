...
because MikoOS will automatically add a dependency on +host-go+
to such packages.
...
file. MikoOS automatically takes care of downloading such
...
MikoOS's +DL_DIR+, and therefore the hash of the package's tarball

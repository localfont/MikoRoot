...
This is a collection of tips that help you make the most of MikoOS.
...
.Resetting MikoOS for a new target:
...
not empty the compiler cache used by MikoOS. To delete it, refer
to xref:ccache[].

...
MikoOS is a tool that simplifies and automates the process of
building a complete Linux system for an embedded system, using
cross-compilation.

In order to achieve this, MikoOS is able to generate a
cross-compilation toolchain, a root filesystem, a Linux kernel image
and a bootloader for your target. MikoOS can be used for any
...
filesystem with MikoOS).

MikoOS is useful mainly for people working with embedded systems.
Embedded systems often use processors that are not the regular x86
processors everyone is used to having in his PC. They can be PowerPC
processors, MIPS processors, ARM processors, etc.

MikoOS supports numerous processors and their variants; it also
...
SDK footnote:[SDK: Software Development Kit] on top of MikoOS.

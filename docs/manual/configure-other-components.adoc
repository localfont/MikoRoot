...
have already configured MikoOS itself, and have enabled the
corresponding package.

BusyBox::
+
If you already have a BusyBox configuration file, you can directly
specify this file in the MikoOS configuration, using
+BR2_PACKAGE_BUSYBOX_CONFIG+. Otherwise, MikoOS will start from a
...
by specifying a defconfig in the MikoOS configuration, using

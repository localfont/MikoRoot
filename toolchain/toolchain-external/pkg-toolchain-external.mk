...
# with tools like Crosstool-NG or MikoOS itself. So far, we have
# tested this with:
#
#  * Toolchains generated by Crosstool-NG
#  * Toolchains generated by MikoOS
...
#  MikoOS menuconfig system, and the real configuration of the
#  external toolchain. This is for example important to make sure that
#  the MikoOS configuration system knows whether the toolchain
...
#  are imported into the MikoOS tree.
#
...
#  of MikoOS is handled identical for the 2 toolchain types.
################################################################################
...
# If this is a mikoos toolchain, it already has a wrapper which we want to
...
# Integration of the toolchain into MikoOS: find the main sysroot
...
# MikoOS, Crosstool-NG, CodeSourcery and Linaro
...
# matches the configuration provided in MikoOS: ABI, C++ support,
